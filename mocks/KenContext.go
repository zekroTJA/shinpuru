...
func (_m *KenContext) FollowUp(wait bool, data *discordgo.WebhookParams) *ken.FollowUpMessage {
	ret := _m.Called(wait, data)

	var r0 *ken.FollowUpMessage
	if rf, ok := ret.Get(0).(func(bool, *discordgo.WebhookParams) *ken.FollowUpMessage); ok {
		r0 = rf(wait, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ken.FollowUpMessage)
		}
	}
...
func (_m *KenContext) FollowUpEmbed(emb *discordgo.MessageEmbed) *ken.FollowUpMessage {
	ret := _m.Called(emb)

	var r0 *ken.FollowUpMessage
	if rf, ok := ret.Get(0).(func(*discordgo.MessageEmbed) *ken.FollowUpMessage); ok {
		r0 = rf(emb)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ken.FollowUpMessage)
...
func (_m *KenContext) FollowUpError(content string, title string) *ken.FollowUpMessage {
	ret := _m.Called(content, title)

	var r0 *ken.FollowUpMessage
	if rf, ok := ret.Get(0).(func(string, string) *ken.FollowUpMessage); ok {
		r0 = rf(content, title)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ken.FollowUpMessage)
