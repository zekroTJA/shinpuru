...
// ApplicationEmoji provides a mock function with given fields: appID, emojiID, options
func (_m *ISession) ApplicationEmoji(appID string, emojiID string, options ...discordgo.RequestOption) (*discordgo.Emoji, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID, emojiID)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for ApplicationEmoji")
	}

	var r0 *discordgo.Emoji
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, ...discordgo.RequestOption) (*discordgo.Emoji, error)); ok {
		return rf(appID, emojiID, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, ...discordgo.RequestOption) *discordgo.Emoji); ok {
		r0 = rf(appID, emojiID, options...)
	} else {
		if ret.Get(0) != nil {
...
// ApplicationEmojiCreate provides a mock function with given fields: appID, data, options
func (_m *ISession) ApplicationEmojiCreate(appID string, data *discordgo.EmojiParams, options ...discordgo.RequestOption) (*discordgo.Emoji, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID, data)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for ApplicationEmojiCreate")
	}

	var r0 *discordgo.Emoji
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *discordgo.EmojiParams, ...discordgo.RequestOption) (*discordgo.Emoji, error)); ok {
		return rf(appID, data, options...)
	}
	if rf, ok := ret.Get(0).(func(string, *discordgo.EmojiParams, ...discordgo.RequestOption) *discordgo.Emoji); ok {
		r0 = rf(appID, data, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*discordgo.Emoji)
		}
...
// ApplicationEmojiDelete provides a mock function with given fields: appID, emojiID, options
func (_m *ISession) ApplicationEmojiDelete(appID string, emojiID string, options ...discordgo.RequestOption) error {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ApplicationEmojiDelete")
	}
...
// ApplicationEmojiEdit provides a mock function with given fields: appID, emojiID, data, options
func (_m *ISession) ApplicationEmojiEdit(appID string, emojiID string, data *discordgo.EmojiParams, options ...discordgo.RequestOption) (*discordgo.Emoji, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID, emojiID, data)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for ApplicationEmojiEdit")
	}

	var r0 *discordgo.Emoji
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *discordgo.EmojiParams, ...discordgo.RequestOption) (*discordgo.Emoji, error)); ok {
		return rf(appID, emojiID, data, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, *discordgo.EmojiParams, ...discordgo.RequestOption) *discordgo.Emoji); ok {
		r0 = rf(appID, emojiID, data, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*discordgo.Emoji)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *discordgo.EmojiParams, ...discordgo.RequestOption) error); ok {
		r1 = rf(appID, emojiID, data, options...)
	} else {
		r1 = ret.Error(1)
	}
...
// ApplicationEmojis provides a mock function with given fields: appID, options
func (_m *ISession) ApplicationEmojis(appID string, options ...discordgo.RequestOption) ([]*discordgo.Emoji, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for ApplicationEmojis")
	}

	var r0 []*discordgo.Emoji
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ...discordgo.RequestOption) ([]*discordgo.Emoji, error)); ok {
		return rf(appID, options...)
	}
...
// Applications provides a mock function with no fields
...
// EntitlementConsume provides a mock function with given fields: appID, entitlementID, options
func (_m *ISession) EntitlementConsume(appID string, entitlementID string, options ...discordgo.RequestOption) error {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID, entitlementID)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for EntitlementConsume")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, ...discordgo.RequestOption) error); ok {
		r0 = rf(appID, entitlementID, options...)
	} else {
		r0 = ret.Error(0)
	}
...
// EntitlementTestCreate provides a mock function with given fields: appID, data, options
func (_m *ISession) EntitlementTestCreate(appID string, data *discordgo.EntitlementTest, options ...discordgo.RequestOption) error {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for EntitlementTestCreate")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, *discordgo.EntitlementTest, ...discordgo.RequestOption) error); ok {
		r0 = rf(appID, data, options...)
	} else {
		r0 = ret.Error(0)
	}
...
// EntitlementTestDelete provides a mock function with given fields: appID, entitlementID, options
func (_m *ISession) EntitlementTestDelete(appID string, entitlementID string, options ...discordgo.RequestOption) error {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for EntitlementTestDelete")
	}
...
// Entitlements provides a mock function with given fields: appID, filterOptions, options
func (_m *ISession) Entitlements(appID string, filterOptions *discordgo.EntitlementFilterOptions, options ...discordgo.RequestOption) ([]*discordgo.Entitlement, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, appID, filterOptions)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for Entitlements")
	}

	var r0 []*discordgo.Entitlement
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *discordgo.EntitlementFilterOptions, ...discordgo.RequestOption) ([]*discordgo.Entitlement, error)); ok {
		return rf(appID, filterOptions, options...)
	}
	if rf, ok := ret.Get(0).(func(string, *discordgo.EntitlementFilterOptions, ...discordgo.RequestOption) []*discordgo.Entitlement); ok {
		r0 = rf(appID, filterOptions, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*discordgo.Entitlement)
		}
	}

	if rf, ok := ret.Get(1).(func(string, *discordgo.EntitlementFilterOptions, ...discordgo.RequestOption) error); ok {
		r1 = rf(appID, filterOptions, options...)
	} else {
		r1 = ret.Error(1)
	}
...
// GatewayWriteStruct provides a mock function with given fields: data
func (_m *ISession) GatewayWriteStruct(data interface{}) error {
	ret := _m.Called(data)

	if len(ret) == 0 {
		panic("no return value specified for GatewayWriteStruct")
	}
...
// HeartbeatLatency provides a mock function with no fields
...
// PollAnswerVoters provides a mock function with given fields: channelID, messageID, answerID
func (_m *ISession) PollAnswerVoters(channelID string, messageID string, answerID int) ([]*discordgo.User, error) {
	ret := _m.Called(channelID, messageID, answerID)

	if len(ret) == 0 {
		panic("no return value specified for PollAnswerVoters")
	}

	var r0 []*discordgo.User
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, int) ([]*discordgo.User, error)); ok {
		return rf(channelID, messageID, answerID)
	}
	if rf, ok := ret.Get(0).(func(string, string, int) []*discordgo.User); ok {
		r0 = rf(channelID, messageID, answerID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*discordgo.User)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, int) error); ok {
		r1 = rf(channelID, messageID, answerID)
	} else {
		r1 = ret.Error(1)
	}
...
// PollExpire provides a mock function with given fields: channelID, messageID
func (_m *ISession) PollExpire(channelID string, messageID string) (*discordgo.Message, error) {
	ret := _m.Called(channelID, messageID)

	if len(ret) == 0 {
		panic("no return value specified for PollExpire")
	}
...
// RequestRaw provides a mock function with given fields: method, urlStr, contentType, b, bucketID, sequence, options
func (_m *ISession) RequestRaw(method string, urlStr string, contentType string, b []byte, bucketID string, sequence int, options ...discordgo.RequestOption) ([]byte, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, method, urlStr, contentType, b, bucketID, sequence)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for RequestRaw")
	}

	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, []byte, string, int, ...discordgo.RequestOption) ([]byte, error)); ok {
		return rf(method, urlStr, contentType, b, bucketID, sequence, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, []byte, string, int, ...discordgo.RequestOption) []byte); ok {
		r0 = rf(method, urlStr, contentType, b, bucketID, sequence, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, []byte, string, int, ...discordgo.RequestOption) error); ok {
		r1 = rf(method, urlStr, contentType, b, bucketID, sequence, options...)
	} else {
		r1 = ret.Error(1)
	}
...
// SKUs provides a mock function with given fields: appID
func (_m *ISession) SKUs(appID string) ([]*discordgo.SKU, error) {
	ret := _m.Called(appID)

	if len(ret) == 0 {
		panic("no return value specified for SKUs")
	}

	var r0 []*discordgo.SKU
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]*discordgo.SKU, error)); ok {
		return rf(appID)
	}
	if rf, ok := ret.Get(0).(func(string) []*discordgo.SKU); ok {
		r0 = rf(appID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*discordgo.SKU)
		}
	}
...
// Subscription provides a mock function with given fields: skuID, subscriptionID, userID, options
func (_m *ISession) Subscription(skuID string, subscriptionID string, userID string, options ...discordgo.RequestOption) (*discordgo.Subscription, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, skuID, subscriptionID, userID)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r0 *discordgo.Subscription
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, ...discordgo.RequestOption) (*discordgo.Subscription, error)); ok {
		return rf(skuID, subscriptionID, userID, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, ...discordgo.RequestOption) *discordgo.Subscription); ok {
		r0 = rf(skuID, subscriptionID, userID, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*discordgo.Subscription)
		}
	}

	if rf, ok := ret.Get(1).(func(string, string, string, ...discordgo.RequestOption) error); ok {
		r1 = rf(skuID, subscriptionID, userID, options...)
	} else {
		r1 = ret.Error(1)
	}
...
// Subscriptions provides a mock function with given fields: skuID, userID, before, after, limit, options
func (_m *ISession) Subscriptions(skuID string, userID string, before *time.Time, after *time.Time, limit int, options ...discordgo.RequestOption) ([]*discordgo.Subscription, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, skuID, userID, before, after, limit)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r0 []*discordgo.Subscription
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *time.Time, *time.Time, int, ...discordgo.RequestOption) ([]*discordgo.Subscription, error)); ok {
		return rf(skuID, userID, before, after, limit, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, *time.Time, *time.Time, int, ...discordgo.RequestOption) []*discordgo.Subscription); ok {
		r0 = rf(skuID, userID, before, after, limit, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*discordgo.Subscription)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *time.Time, *time.Time, int, ...discordgo.RequestOption) error); ok {
		r1 = rf(skuID, userID, before, after, limit, options...)
	} else {
		r1 = ret.Error(1)
	}
...
// UserUpdate provides a mock function with given fields: username, avatar, banner, options
func (_m *ISession) UserUpdate(username string, avatar string, banner string, options ...discordgo.RequestOption) (*discordgo.User, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, username, avatar, banner)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r0 *discordgo.User
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, ...discordgo.RequestOption) (*discordgo.User, error)); ok {
		return rf(username, avatar, banner, options...)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, ...discordgo.RequestOption) *discordgo.User); ok {
		r0 = rf(username, avatar, banner, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*discordgo.User)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, ...discordgo.RequestOption) error); ok {
		r1 = rf(username, avatar, banner, options...)
	} else {
		r1 = ret.Error(1)
	}
